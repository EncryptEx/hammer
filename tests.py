...
class HammerTest (unittest.TestCase):
    ...
    def test_lanugages(self):
        ...
        for languageFile in langFiles:
            ...
            self.assertEqual(len(dictionary.items()),89, "There's a missing line in the language json file: "+filename)
